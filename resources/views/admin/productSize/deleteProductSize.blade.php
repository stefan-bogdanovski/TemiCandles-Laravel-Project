        ...
        <div class="content mt-0">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 col-md-9 col-sm-12 text-center">
                    <h2>Izbrišite veličinu zadatom proizvodu</h2>
                    <form action="{{route($entity. '.deleteProductSize')}}" method="POST">
                        @CSRF
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="product">Proizvod</label>
                                <select id="product" name="product" class="form-control">
                                    <option value="0">Izaberite proizvod kome brišete veličinu..</option>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select id="product" name="size" class="form-control">
                                    <option value="0">Izaberite veličinu koja se briše..</option>
                        ...
                        @endif
                        <input type="submit" class="btn colorform form-control text-gray-dark" value="Obriši veličinu proizvodu"/>
                    </form>
                </div>
            </div>
        </div>
